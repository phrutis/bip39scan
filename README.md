...
**У меня не запускается программа! Такая ошибка и такая..**
Скачайте самые новые (почледние) драйвера для вашей видеокарты. Если проблема не исчезла напишите об жтом в чате. Сделайте скриншот окна программы.
